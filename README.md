...
🎓 I'm a Computer Science Engineering student passionate about building **intelligent, real-world software** that connects AI with modern development frameworks.
...
An AI-powered face recognition, clustering, and verification system using FastAPI, FAISS, and Google Vision API.  
- Detects and recognizes faces from uploaded images  
- Stores embeddings and metadata for fast retrieval  
- Clusters unknown faces intelligently  
- Includes a modern Streamlit-based UI for interaction  
